...
Command: npx gltfjsx@6.5.3 /tmp/avatar.glb -o src/components/tv/AvatarModel.tsx 
*/
...
type ActionName = 'allGrip_L' | 'allGrip_R' | 'allOpen_L' | 'allOpen_R' | 'idle_eyes_2' | 'idle_eyes' | 'indexDown_L' | 'indexDown_R' | 'mrpDown_L' | 'mrpDown_R' | 'pinch_L' | 'pinch_R' | 'point_L' | 'point_R' | 'thumbDown_L' | 'thumbDown_R' | 'thumbsUp_L' | 'thumbsUp_R'
